...
const docRows: DocRow[] = [
  {
    ...
    body: (
      <p>
        Mask is a soft pastel gradient block used as a placeholder, avatar
        stand-in, or decorative surface. Rendered as a rounded-16 square with
        a lilac-to-periwinkle vertical gradient.
      </p>
    ),
  },
  {
    ...
    body: (
      <p>
        Use as a neutral placeholder while media is loading, or as a subtle
        decorative element in empty states. The gradient is intentionally
        understated — it should sit in the background, not compete with the
        primary content.
      </p>
    ),
    divider: "emphasis",
...
/** 1:1 reproduction of the Figma symbol (80×80). */
...
function PropsTableRow() {
  const props = [
    { name: "size", type: "number", default: "80", description: "Square size in pixels." },
