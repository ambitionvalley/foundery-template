...
const docRows: DocRow[] = [
  {
    ...
    body: (
      <p>
        Notifications is a glassy popover that lists recent activity —
        deploys, registrations, subscriptions, mentions. 248px wide with a
        Semibold heading above a vertical stack of icon + title + timestamp
        rows.
      </p>
    ),
  },
  {
    ...
    body: (
      <p>
        ...
        so it floats over any background. Highlight one row with
        <code>active</code> to mark keyboard focus or the most-recent-read
        item. Pair the popover with a bell trigger in the product header.
      </p>
    ),
    divider: "emphasis",
  },
...
/** 1:1 reproduction of the Figma symbol (248×308). */
...
function PropsTableRow() {
  const props = [
    { name: "title", type: "ReactNode", default: '"Notifications"', description: "Heading label." },
