...
const docRows: DocRow[] = [
  {
    ...
    body: (
      <p>
        Scroll Bar is a decorative thumb used inside custom scroll containers.
        Two states: 4px wide at rest and 8px wide on hover.
      </p>
    ),
  },
  {
    ...
    body: (
      <p>
        The thumb is purely visual — layouts should delegate the actual
        scrolling behaviour to native scroll or a headless scroll primitive.
        Use this component to render the thumb overlay.
      </p>
    ),
    divider: "emphasis",
  },
...
/** 1:1 reproduction of the Figma canvas (72×120). */
...
function PropsTableRow() {
  const props = [
    { name: "hover", type: "boolean", default: "false", description: "Switch to the 8px hovered thumb." },
    { name: "length", type: "number", default: "80", description: "Thumb length in pixels." },
...
export default function ScrollBarShowcasePage() {
  return (
