...
const docRows: DocRow[] = [
  {
    ...
    body: (
      <p>
        Badge is a small status indicator. Two types: a decorative dot, or a
        compact numeric pill for counters.
      </p>
    ),
  },
  {
    ...
    body: (
      <p>
        Badges are decorative (<code>aria-hidden</code>). Pair with a clear
        surrounding label for accessibility. For counts above 99, render
        <code>&ldquo;99+&rdquo;</code>.
      </p>
    ),
    divider: "emphasis",
  },
...
/** 1:1 reproduction of the Figma canvas (101×60). */
    ...
    <section className="flex w-full flex-wrap items-start gap-x-1 gap-y-4 border-b border-b-black/10 py-[28px]">
      ...
      <div className="flex min-w-[358px] flex-1 flex-col items-start">
        <div
          ...
          style={{ width: 101, height: 60 }}
        >
          <div className="absolute" style={{ left: 20, top: 20 }}>
            <Badge type="dot" />
          </div>
          <div className="absolute" style={{ left: 56, top: 20 }}>
...
function PropsTableRow() {
  const props = [
    { name: "type", type: '"dot" | "number"', default: '"dot"', description: "Decorative dot or numeric pill." },
    { name: "children", type: "ReactNode", default: "—", description: 'Content when type="number".' },
