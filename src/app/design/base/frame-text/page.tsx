...
import { FrameText } from "@/components/base/frame-text";
...
const docRows: DocRow[] = [
  {
    ...
    body: (
      <p>
        Single-label slot — the text counterpart to the Icon slot. A 14/20
        label wrapped in the same 12px-rounded hoverable surface used by the
        rest of the Frame family.
      </p>
    ),
  },
  {
    ...
    body: (
      <p>
        The component&apos;s children render as the label. Use it when a lone
        piece of text needs to share row layouts with Icon Slot, Frame, and
        the other Frame compositions.
      </p>
    ),
    divider: "emphasis",
  },
...
const SLOTS: { x: number; hover: boolean }[] = [
  ...
  { x: 59, hover: true },  // Hover
  { x: 98, hover: false }, // Static
];

/** 1:1 reproduction of the Figma canvas (147×60). */
...
export default function FrameTextShowcasePage() {
  return (
